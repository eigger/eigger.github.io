...
(function (global) {
  ...
  const STRINGS = {
    ko: {
      ...
      // Layout Uploader (Expert)
      'layout.title': 'Gicisky Layout Uploader (Expert)',
      'layout.pageTitle': '전자 라벨 (Gicisky) Layout Uploader',
      'layout.badge': 'Expert',
      'layout.intro': '텍스트·도형·이미지·QR로 레이아웃을 만든 뒤 BLE로 업로드합니다. 일반 사진 업로드는 기존 업로더를 사용하세요.',
      'layout.navSimple': '← 일반 업로더',
      'layout.navYaml': 'HA YAML 에디터',
      'layout.step1': '1. 라벨 번호 · 타입',
      'layout.bg': '배경',
      'layout.step2': '2. 레이아웃',
      'layout.hintCanvas': '캔버스: 드래그로 이동 · 모서리 핸들로 크기 조절 · Delete로 삭제 · 휠로 확대/축소. 이미지 요소는 Properties에서 디더링/임계값 설정. 저장 파일에 이미지도 포함됩니다.',
      'layout.save': '레이아웃 저장',
      'layout.load': '레이아웃 불러오기',
      'layout.clear': '레이아웃 비우기',
      'layout.elements': '요소',
      'layout.properties': '속성',
      'layout.emptyAdd': '요소를 추가하세요',
      'layout.emptySelect': '선택 없음',
      'layout.actUp': '위로',
      'layout.actDown': '아래로',
      'layout.actDup': '복제',
      'layout.actDel': '삭제',
      'layout.step3': '3. 최종 미리보기 · 업로드',
      'layout.hintPreview': '디더링·임계값은 이미지 요소 Properties에서만 설정합니다. 텍스트/도형/QR은 선명하게 유지되고, 레이아웃을 바꾸면 최종 미리보기가 자동으로 갱신됩니다.',
      'layout.previewBtn': '최종 미리보기',
      'layout.pngSave': 'PNG 저장',
      'layout.upload': '레이아웃 업로드',
      'layout.previewHeading': '최종 결과 (기기에 표시될 모습)',
      'layout.previewMetaIdle': '미리보기를 생성하세요',
      'layout.previewMeta': '{model} · {width}×{height} · payload {kb} KB',
      'layout.toolText': '📝 Text',
      'layout.toolRect': '▭ Rect',
      'layout.toolLine': '━ Line',
      'layout.toolCircle': '◯ Circle',
      'layout.toolImage': '🖼 Image',
      'layout.toolQr': '⊞ QR',
      'layout.clearConfirm': '현재 레이아웃을 모두 지울까요?',
      'layout.saveFail': '저장 실패: {error}',
      'layout.loadFail': '불러오기 실패: {error}',
      'layout.invalidJson': '유효한 레이아웃 JSON이 아닙니다.',
      'layout.noPayload': '업로드할 데이터가 없습니다.',
    ...
    en: {
      ...
      // Layout Uploader (Expert)
      'layout.title': 'Gicisky Layout Uploader (Expert)',
      'layout.pageTitle': 'E-Label (Gicisky) Layout Uploader',
      'layout.badge': 'Expert',
      'layout.intro': 'Build a layout with text, shapes, images, and QR, then upload over BLE. Use the standard uploader for simple photo uploads.',
      'layout.navSimple': '← Standard uploader',
      'layout.navYaml': 'HA YAML editor',
      'layout.step1': '1. Label number · type',
      'layout.bg': 'Background',
      'layout.step2': '2. Layout',
      'layout.hintCanvas': 'Canvas: drag to move · corner handles to resize · Delete to remove · wheel to zoom. Set dither/thresholds per image in Properties. Saved files include embedded images.',
      'layout.save': 'Save layout',
      'layout.load': 'Load layout',
      'layout.clear': 'Clear layout',
      'layout.elements': 'Elements',
      'layout.properties': 'Properties',
      'layout.emptyAdd': 'Add an element',
      'layout.emptySelect': 'Nothing selected',
      'layout.actUp': 'Move up',
      'layout.actDown': 'Move down',
      'layout.actDup': 'Duplicate',
      'layout.actDel': 'Delete',
      'layout.step3': '3. Final preview · upload',
      'layout.hintPreview': 'Dither and thresholds are set only on image elements in Properties. Text, shapes, and QR stay sharp; the final preview updates automatically when you change the layout.',
      'layout.previewBtn': 'Final preview',
      'layout.pngSave': 'Save PNG',
      'layout.upload': 'Upload layout',
      'layout.previewHeading': 'Final result (as shown on device)',
      'layout.previewMetaIdle': 'Generate a preview',
      'layout.previewMeta': '{model} · {width}×{height} · payload {kb} KB',
      'layout.toolText': '📝 Text',
      'layout.toolRect': '▭ Rect',
      'layout.toolLine': '━ Line',
      ...
      'layout.toolImage': '🖼 Image',
      'layout.toolQr': '⊞ QR',
      'layout.clearConfirm': 'Clear the current layout?',
      'layout.saveFail': 'Save failed: {error}',
      'layout.loadFail': 'Load failed: {error}',
      'layout.invalidJson': 'Not a valid layout JSON.',
      'layout.noPayload': 'Nothing to upload.',
      'layout.github': 'GitHub',
    },
  };
  ...
  function applyDom(root) {
    ...
    const titleKey = document.documentElement.getAttribute('data-i18n-doc-title') || 'title';
